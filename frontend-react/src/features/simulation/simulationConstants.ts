...
export const THRUST_BRAKE_KEY_CODE = 'Space';
export const SHIELD_KEY_CODE = 'KeyS';
export const CHARGE_KEY_CODE = 'KeyD';
export const ROTATE_LEFT_KEY_CODE = 'KeyQ';
export const ROTATE_RIGHT_KEY_CODE = 'KeyE';
// One session budget covers steering, braking and every pulse. A pulse reserves the final token
// for a level release. The server's larger 30-token/20-per-second bucket retains room for tuning.
export const INPUT_COMMAND_BUDGET_CAPACITY = 8;
export const INPUT_COMMAND_BUDGET_REFILL_PER_SECOND = 16;
export const INPUT_COMMAND_PULSE_MINIMUM_TOKENS = 2;
