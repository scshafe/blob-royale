...
// already stripped it before this snapshot existed, so the leak protocol v2 withholds is closed at
...
// `protocol_v2_constants.hpp` for why absence is ordinary.
// related: docs/protocol/schema/v2/controllable-component.schema.json -- the closed wire shape.
