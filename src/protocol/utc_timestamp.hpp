...
// until protocol v2 needed the same answer; a second copy would have been two answers to one
...
// related: protocol_v2_json_encoding.hpp -- the v2 encoders that validate it.
